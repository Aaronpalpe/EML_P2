...
Se observa que este método consigue prácticamente en su totalidad el efecto del nodo malicioso:
...
\begin{itemize}
    ...
    \item El F1-score final se sitúa en torno a 0.47, lo que supone una mejora significativa frente al caso atacado sin mecanismos de defensa.
...
\begin{minipage}{\textwidth}
    ...
    \begin{tabular}{cc}
        ...
        \includegraphics[width=0.3\textwidth]{images/krum_cm_malicious.png} &
        \includegraphics[width=0.3\textwidth]{images/krum_cm_honest.png} \\
    \end{tabular}
