...
\begin{minipage}{\textwidth}
    \centering
    \includegraphics[width=0.5\textwidth]{images/trimmed_mean_f1.png}
...
\begin{minipage}{\textwidth}
    \centering
    \includegraphics[width=0.5\textwidth]{images/krum_bueno.png}
...
\begin{minipage}{\textwidth}
    ...
    \begin{tabular}{cc}
        ...
        \includegraphics[width=0.25\textwidth]{images/krum_cm_malicious.png} &
        \includegraphics[width=0.25\textwidth]{images/krum_cm_honest.png} \\
    \end{tabular}
