...
\begin{minipage}{\textwidth}
    ...
    \begin{tabular}{cc}
        ...
        \includegraphics[width=0.35\textwidth]{images/model_poisoning_20_bueno.png} &
...
\begin{itemize}
    ...
    \item Con un 50\% de nodos maliciosos, el modelo logra converger estancándose de manera uniforme en un F1-score de 0.15.
\end{itemize}
...
\begin{itemize}
    ...
    primero reduce la convergencia (F1-score $\leq 0.08$), el segundo logra engañar al modelo llevándolo a una 
    convergencia falsa pero ligeramente superior (F1-score 0.16).
    \item A medida que aumenta el porcentaje de clientes maliciosos (20\% $\rightarrow$ 50\%), la métrica final 
    ...
    leve (20\% \textit{label flipping}), el F1-score ya cae por debajo del caso base a 0.48. 
    En las condiciones de ataque más severas (50\% \textit{model poisoning}), el modelo se desploma hasta un 0.02. 
    Esto evidencia que los entornos non-IID son frágiles ante actualizaciones maliciosas, ya que a la agregación 
